...
const plans = [
  {
    ...
    price: "0",
    period: "forever",
    description: "Discover keto with AI",
    features: [
      "1 week meal plan",
  ...
  },
  {
    ...
    price: "14",
    period: "month",
    description: "The full keto experience",
    features: [
      ...
      <ul className="space-y-3 flex-1 mb-8">
        {plan.features.map((f) => (
          <li
            ...
            style={{ color: plan.highlight ? "rgba(255,255,255,0.9)" : "var(--text-muted)" }}
          >
            <div
              className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0"
              style={{
                background: plan.highlight ? "rgba(255,255,255,0.2)" : "var(--accent-light)",
              }}
            >
              <Check
                className="w-3 h-3 font-black"
                style={{ color: plan.highlight ? "#fff" : "var(--accent)" }}
                strokeWidth={3}
              />
            </div>
            {f}
